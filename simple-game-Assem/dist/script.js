...
// This is a container style that moving container player in the game
...
// This function method sets the random generated blocks on the screen at given coordinates
...
// This function checks if the hurdle block and the player block co-ordinate intersects to each other, returns true if intersects otherwise false
...
/*****PLAYER****/
/**************/
// This is a constructor of function Player which initializes the style parameters and positions of the moving player
...
Player.prototype.update = function () {
  ...
  // This handles the jump velocity on event like pressing up or scape or w key or even when clicking on screen
  if (
...
// This function draws the shape of player and blocks on the screen
...
/*******************PLATFORM MANAGER*************/
// This function manages the game platform configurations
...
/*******************PARTICLE SYSTEM*************/
// This is the game player shadow settings "bottom particles".
...
// This function draws the shapes of shadow particles on the screen
...
/************************************************/
// This is the game player settings moving, jumping and speed
  ...
  for (i = 0; i < this.platformManager.platforms.length; i++) {
    if (this.player.insercects(this.platformManager.platforms[i])) {
      ...
      if (this.player.insercectsLeft(this.platformManager.platforms[i])) {
        ...
        for (i = 0; i < 10; i++) {
          this.particles[
            this.particlesIndex++ % this.particlesMax
          ] = new Particle({
